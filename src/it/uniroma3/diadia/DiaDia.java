...
public class DiaDia {
	...
	private boolean processaIstruzione(String istruzione) {
		...
		// risoluzione problema di input vuoto con funzione delle stringhe
	...
	private void prendi(String attrezzo) {
		// lo prendo e lo salvo se ci sta
	...
	private void posa(String attrezzo) {
		// remove dalla borsa e add alla stanza. Ritorna un attrezzo da inserire etc...
		// dovuto salvare perchè prima controllo se ci sta sto oggetto 
